...
const translations: Record<Language, Record<string, string>> = {
  id: {
    ...
    "management.property.cms": "Buka CMS Properti",
    "management.edit": "Edit",
    "management.delete": "Hapus",
    "management.cancel": "Batal",
    "management.occupied": "Dihuni",
    "management.vacant": "Kosong",
    "management.actions": "Tindakan",
    "management.open_menu": "Buka Menu",
    "management.property.list": "Daftar Properti",
    "management.property.manage_description": "Kelola semua properti Anda dari satu tempat",
    "management.property.count": "{{count}} properti ditemukan",
    "management.property.empty": "Belum ada properti yang terdaftar",
    "management.property.no_results": "Tidak ada properti yang cocok dengan pencarian Anda",
    "management.property.deleted": "Properti berhasil dihapus",
    "management.property.delete_confirm_title": "Hapus Properti?",
    "management.property.delete_confirm_description": "Tindakan ini tidak dapat dibatalkan. Properti ini akan dihapus secara permanen dari sistem kami.",
  ...
  en: {
    ...
    "management.property.cms": "Open Property CMS",
    "management.edit": "Edit",
    ...
    "management.open_menu": "Open Menu",
    "management.property.list": "Property List",
    "management.property.manage_description": "Manage all your properties from one place",
    "management.property.count": "{{count}} properties found",
    "management.property.empty": "No properties registered yet",
    "management.property.no_results": "No properties match your search",
    "management.property.deleted": "Property successfully deleted",
    "management.property.delete_confirm_title": "Delete Property?",
    "management.property.delete_confirm_description": "This action cannot be undone. This property will be permanently deleted from our system.",
